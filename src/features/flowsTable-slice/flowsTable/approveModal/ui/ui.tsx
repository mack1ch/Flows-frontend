                ...
                footer={
                    <>
                        <ConfigProvider theme={modalTheme}>
                            <Button loading={confirmLoading} onClick={handleOk} key="submit">
                                Отправить
                            </Button>
                        </ConfigProvider>
                    </>
                    ...
                    <div className={styles.layout}>
                        ...
                        <Form
                            ...
                            <Form.Item
                                style={{ width: '100%' }}
                                required
                                tooltip="Ключевые слова вашего проекта, обозначение темы или смысла"
                                label="Ключевые теги">
                                <Input
                                    width={360}
                                    size="large"
